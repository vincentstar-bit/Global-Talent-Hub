      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { name: "Director of IR", person: "Monica Chen", email: "support@dynamicoffshoredrilling.com", phone: "+86 10 8888 6666 ext. 810", region: "Global" },
              { name: "IR Manager — Europe", person: "James Worthington", email: "support@dynamicoffshoredrilling.com", phone: "+44 20 7888 4410", region: "Europe / Americas" },
              { name: "IR Manager — Asia", person: "Alicia Tan", email: "support@dynamicoffshoredrilling.com", phone: "+65 6888 9910", region: "Asia Pacific" },
            ].map((c) => (
