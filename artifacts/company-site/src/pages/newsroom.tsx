          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { name: "Global Media Relations", email: "support@dynamicoffshoredrilling.com", phone: "+86 10 8888 6666 ext. 800" },
                  { name: "Investor Relations", email: "support@dynamicoffshoredrilling.com", phone: "+86 10 8888 6666 ext. 810" },
                  { name: "ESG & Sustainability", email: "support@dynamicoffshoredrilling.com", phone: "+86 10 8888 6666 ext. 820" },
                ].map((c) => (
