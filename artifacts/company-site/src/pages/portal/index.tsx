          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-xs leading-relaxed max-w-2xl">
                Access is restricted to verified employees only. Each session is authenticated via a unique access token. Dynamic Offshore Drilling Enterprise does not store your session beyond your visit. For security concerns, contact <span className="text-foreground">hr@dynamicoffshore.com</span>.
              </p>
            </div>
          </div>
        </div>
