        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-8 text-xs text-white/40">
            <div className="flex items-center gap-6">
              ...
              <a href="mailto:support@dynamicoffshoredrilling.com" className="flex items-center gap-1.5 hover:text-[#c9a227] transition-colors">
                <Mail className="w-3 h-3" /> support@dynamicoffshoredrilling.com
              </a>
